...
%----------HEADING-----------------
\begin{center}
  \textbf{\huge \hspace{-1cm} DANIEL BRITO} \\ 
  \textbf{\hspace{-1cm} Front-end and Android developer • Visual artist • Writer} \\
\end{center}
...
\section{\faUniversity \hspace{0.2cm} Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \begin{itemize}
          \item \textbf{Scholarships}
            \begin{itemize}
            \resumeScholarship
                {Program for Beginning Teachers:}{\faCalendar \hspace{0.1cm} \textit{\small Feb 2019 - Dec 2019}}
                {Academic mentoring for IT and engineering courses (C and Python).}{}
            
            \resumeScholarship
                {Program of Academic Initiation:}{\faCalendar \hspace{0.1cm} \textit{\small Apr 2018 - Dec 2018}}
                {Practical studies of 3D modeling and Virtual Reality using Blender.}{}
        
            \resumeScholarship
                {Program of Academic Initiation:}{\faCalendar \hspace{0.1cm} \textit{\small Jun 2017 - Dec 2017}}
    ...
    \resumeSubheading
      {Faculty of Technology}{\faMapMarker \hspace{0.1cm} São Paulo, SP}
      {Technologist in Analysis and Systems Development}{\faCalendar \hspace{0.1cm} 2012 - 2016}
      \begin{itemize}
          \item Unfinished.
      \end{itemize}
...
\section{\faPuzzlePiece \hspace{0.2cm} Skills}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubItem {Front-end:}{HTML5, CSS3, Bootstrap, Material-UI, ReactJS, Styled Components, TypeScript, Sass, JQuery.}
