...
\section{\faRocket \hspace{0.2cm} \Large Projects}
    \resumeSubHeadingListStart
        \resumeSubItem{Technology}{}
            \begin{itemize}
                \item \textbf{HáLugar:} Housing app for students. Developed for Android platform, using technologies such as Google Maps, Nominatim API, PhotoView, and Firebase (Auth, Realtime Database, Storage). \href{https://play.google.com/store/apps/details?id=br.ufc.crateus.halugar}{\faInfoCircle}
