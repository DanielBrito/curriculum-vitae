...
\section{\faBriefcase \hspace{0.2cm} \Large Experience}
    ...
    \resumeSubHeadingListStart
        ...
        \begin{itemize}
            \item Development of efficient and scalable systems using the best technologies available in the market.
        \end{itemize}
    \resumeSubHeadingListEnd
...
\section{\faPuzzlePiece \hspace{0.2cm} \Large Skills}
    ...
    \resumeSubHeadingListStart
        ...
        \resumeSubItem {Graphic Design:}{Figma, Draw.io, Photoshop, Inkscape, Blender.}
        ...
        \vspace{0.2cm} % Space between section
    \resumeSubHeadingListEnd
