...
Passionate about learning and creating things, both in the fields of art and technology. Currently, focusing on topics concerning front-end development of web and mobile applications, but following the steps to become a full-stack developer.
...
\section{\faBriefcase \hspace{0.2cm} \Large Experience}
    \resumeSubHeadingListStart
        ...
        \begin{itemize}
            \item Our team developed a web and mobile application to optimize the patient admission process at Instituto Pró-Hemoce. Despite the affinity for learning front-end subjects, there was also a contact with concepts and technologies related to the back-end and DevOps. During this process, we followed some agile methodologies principles, such as Scrum and Kanban. \\
            \begin{itemize}
...
\section{\faPuzzlePiece \hspace{0.2cm} \Large Skills}
    ...
    \resumeSubHeadingListStart
        ...
        \resumeSubItem {Mobile:}{Android, Retrofit, Glide, PhotoView, Compressor, Google Maps, Realm.}
...
\section{\faRocket \hspace{0.2cm} \Large Projects}
    \resumeSubHeadingListStart
        \resumeSubItem{Technology}{}
            \begin{itemize}
                \item \textbf{HáLugar:} Housing app for students. Developed for Android platform using technologies such as Google Maps, Nominatim API, Glide, PhotoView, and Firebase (Auth, Realtime Database, Storage). \href{https://play.google.com/store/apps/details?id=br.ufc.crateus.halugar}{\scriptsize \faExternalLink}
