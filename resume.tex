...
\section{\faBriefcase \hspace{0.2cm} \Large Experience}
    ...
    \resumeSubHeadingListStart
        ...
        \begin{itemize}
            \item Development of new features for a Human Resources management platform (RHeuni), such as an agenda for collaborators, events, and room reservation, besides the storage of recorded meetings and workshop files. Some of the activities performed include Software Architecture, through the construction of REST APIs, UI/UX Design, and more.
            \begin{itemize}
                ...
                \item \textbf{Design:} Draw.io, Figma.
            \end{itemize}
        \end{itemize}
    \resumeSubHeadingListEnd
    ...
    \resumeSubHeadingListStart
        \resumeSubItem{Technology}{}
            \begin{itemize}
                ...
                \item \textbf{Home:} Refactored version of first personal website using ReactJS and Material-UI. \href{https://danielbrito.github.io/home/}{\scriptsize \faExternalLink}
            \end{itemize}
