...
Passionate about learning and creating things, both in the fields of technology and art. Currently, focusing on topics concerning front-end development of web and mobile applications, but searching for opportunities to follow the steps to become a full-stack developer.
    ...
    \resumeSubHeadingListStart
        ...
        \begin{itemize}
            \item \textbf{Volunteer}
                \begin{itemize}
                    \item \textbf{GEMP:} Group of studies for the SBC Programming Marathon. \href{https://github.com/GEMP-UFC-Crateus}{\small \faExternalLink}
                \end{itemize}
        \end{itemize}
...
\section{\faPuzzlePiece \hspace{0.2cm} \Large Skills}
    Main knowledge that I've been acquiring while studying and working on personal and professional projects as a software developer.
    \resumeSubHeadingListStart
        \resumeSubItem {Programming Languages:}{C, Java, C++, JavaScript, Python.}
        \resumeSubItem {Front-end:}{HTML, CSS, Bootstrap, Material-UI, ReactJS, Styled Components, TypeScript, Sass, JQuery.}
...
\section{\faRocket \hspace{0.2cm} \Large Projects}
    \resumeSubHeadingListStart
        \resumeSubItem{Technology}{}
            \begin{itemize}
                \item \textbf{HáLugar:} Housing app for students. Developed for Android platform, using technologies such as Google Maps, Nominatim API, PhotoView, and Firebase (Auth, Realtime Database, Storage). \href{https://play.google.com/store/apps/details?id=br.ufc.crateus.halugar}{\small \faExternalLink}
                \item \textbf{Compixelar:} Development of multimedia experiments using Processing. \href{https://medium.com/@danielhbrito}{\small \faExternalLink}
            \end{itemize}
            
        \resumeSubItem{Education}{}
            \begin{itemize}
                \item \textbf{sTuring:} Scientific divulgation. \href{https://www.instagram.com/sturing.compsci/}{\small \faExternalLink}
                \item \textbf{YouTube Channel:}  Programming tutorials for beginners. \href{https://www.youtube.com/channel/UC4y3uq1d7MKDYs1LbI44Vng}{\small \faExternalLink}
            \end{itemize}
            
        \resumeSubItem{Art}{}
            \begin{itemize}
                \item \textbf{Aluminions:} Creation of characters using aluminum seals. \href{https://www.instagram.com/aluminions.13/}{\small \faExternalLink}
            \end{itemize}
...
\section{\faBook \hspace{0.2cm} \Large Publications}
    \resumeSubHeadingListStart
        \resumeSubItem{Books}{}
            \begin{itemize}
                \item \textbf{A Ler Vazios:} Poetic and visual experiments.
                \item \textbf{Protestizando:} Compilation of poems.
            \end{itemize}
