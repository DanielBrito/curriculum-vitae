...
%--------PROFILE------------
\section{\faUser \hspace{0.2cm} Profile}
...
%-----------EXPERIENCE-----------------
\section{\faBriefcase \hspace{0.2cm} Experience}
...
%--------SKILLS------------
\section{\faPuzzlePiece \hspace{0.2cm} Skills}
...
\section{\faRocket \hspace{0.2cm} Projects}
    \resumeSubHeadingListStart
        \resumeSubItem{Technology}{}
            \begin{itemize}
                \item \textbf{HáLugar:} Housing app for students. Developed for Android platform, using technologies such as Nominatim API, Google Maps, PhotoView, and Firebase (Auth, Realtime Database, Storage). \href{https://play.google.com/store/apps/details?id=br.ufc.crateus.halugar}{\faInfoCircle}
