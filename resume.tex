...
\vspace{0.6cm} % Space between sections
...
\section{\faPuzzlePiece \hspace{0.2cm} \Large Skills \& Interests}
    ...
    \resumeSubHeadingListStart
        ...
        \resumeSubItem {Design:}{UI/UX, Figma, Adobe XD, Photoshop, Inkscape, Blender, Balsamiq.}
        ...
        \resumeSubItem {Testing:} {React Testing Library, Cypress, MockK.}
        \resumeSubItem {DevOps:}{Git, GitHub, CircleCI, Docker, Azure, GitLab.}
        \resumeSubItem {Tools:}{Visual Studio Code, IntelliJ IDEA, DBeaver, Postman, Microsoft Office.}
        \resumeSubItem {Subjects:}{Software Architecture, Test-Driven Development, Domain-Driven Design, Data Structures, Design Patterns.}
        \resumeSubItem {Soft Skills:}{Communication, teamwork, organization, creativity, critical thinking.}
        
        \vspace{0.8cm} % Space between section
    \resumeSubHeadingListEnd
...
\section{\faTrophy \hspace{0.2cm} \Large Awards}
    \resumeSubHeadingListStart
        ...
        {Hackathon HackPI Ceará, promoted by the Federal University of Ceará (UFC) and the State Education Department (SEDUC) along with the University of São Paulo (USP).}
        
        \vspace{0.2cm}
        
        \resumeSubItem{First Place:}
        {Hackathon FIT-ON, promoted during the Innovation and Technology Forum at the Federal University of Ceará (UFC).}
        
        \vspace{0.2cm}
        
        \resumeSubItem{Best Work:}
        {Project ``Practical studies of 3D modeling and Virtual Reality using Blender'' during the University Meetings at the Federal University of Ceará (UFC).}
...
\section{\faThumbsUp \hspace{0.2cm} \Large Hobbies}
    ...
    Generative design, chess, astronomy, philosophy, literature, mathematics, history, poetry, calisthenics, running, skateboarding, cycling, music, cinema, traveling, researching, and blogging.
